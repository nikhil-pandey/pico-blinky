...
async fn main(spawner: Spawner) {
    ...
    let fw = F43439A0_bin;
    let clm = F43439A0_clm_bin;
    let btfw = F43439A0_btfw_bin;
    ...
    let host_resources: &mut BleHostResources<4, 32, 27> =
        HOST_RESOURCES.init(BleHostResources::new(PacketQos::None));
